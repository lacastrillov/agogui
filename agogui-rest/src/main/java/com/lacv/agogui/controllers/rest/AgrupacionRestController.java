 ...
 */
@Controller
@RequestMapping(value="/rest/agrupacion")
public class AgrupacionRestController extends RestEntityController {
    ...
    @PostConstruct
    public void init(){
        super.addControlMapping("agrupacion", agrupacionService, agrupacionMapper);
    }
