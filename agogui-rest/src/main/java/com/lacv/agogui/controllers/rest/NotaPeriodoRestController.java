 ...
 */
@Controller
@RequestMapping(value="/rest/notaPeriodo")
public class NotaPeriodoRestController extends RestEntityController {
    ...
    @PostConstruct
    public void init(){
        super.addControlMapping("notaPeriodo", notaPeriodoService, notaPeriodoMapper);
    }
