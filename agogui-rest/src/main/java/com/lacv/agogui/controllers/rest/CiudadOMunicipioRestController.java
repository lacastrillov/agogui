 ...
 */
@Controller
@RequestMapping(value="/rest/ciudadOMunicipio")
public class CiudadOMunicipioRestController extends RestEntityController {
    ...
    @PostConstruct
    public void init(){
        super.addControlMapping("ciudadOMunicipio", ciudadOMunicipioService, ciudadOMunicipioMapper);
    }
