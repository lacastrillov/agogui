 ...
 */
@Controller
@RequestMapping(value="/rest/evaluacion")
public class EvaluacionRestController extends RestEntityController {
    ...
    @PostConstruct
    public void init(){
        super.addControlMapping("evaluacion", evaluacionService, evaluacionMapper);
    }
