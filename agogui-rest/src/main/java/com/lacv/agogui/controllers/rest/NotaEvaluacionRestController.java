 ...
 */
@Controller
@RequestMapping(value="/rest/notaEvaluacion")
public class NotaEvaluacionRestController extends RestEntityController {
    ...
    @PostConstruct
    public void init(){
        super.addControlMapping("notaEvaluacion", notaEvaluacionService, notaEvaluacionMapper);
    }
