 ...
 */
@Controller
@RequestMapping(value="/rest/institucion")
public class InstitucionRestController extends RestEntityController {
    ...
    @PostConstruct
    public void init(){
        super.addControlMapping("institucion", institucionService, institucionMapper);
    }
