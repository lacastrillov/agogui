 ...
 */
@Controller
@RequestMapping(value="/rest/docenteAsignatura")
public class DocenteAsignaturaRestController extends RestEntityController {
    ...
    @PostConstruct
    public void init(){
        super.addControlMapping("docenteAsignatura", docenteAsignaturaService, docenteAsignaturaMapper);
    }
