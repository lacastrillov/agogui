 ...
 */
@Controller
@RequestMapping(value="/vista/periodo")
public class PeriodoViewController extends ExtEntityController {
    ...
    @PostConstruct
    public void init(){
        EntityConfig view= new EntityConfig("periodo", periodoService, PeriodoDto.class);
        view.setSingularEntityTitle("Periodo");
