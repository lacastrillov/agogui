...
@NamedQueries({
    @NamedQuery(name = "NotaPeriodo.findAll", query = "SELECT n FROM NotaPeriodo n")})
public class NotaPeriodo implements BaseEntity {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NotaPeriodo)) {
            return false;
        }
        NotaPeriodo other = (NotaPeriodo) object;
    ...
    public String toString() {
        return "com.lacv.agogui.model.entities.NotaPeriodo[ id=" + id + " ]";
    }
